...
const STATUS_META: Record<ProjectStatus, { label: string; tone: StatusTone }> = {
  ...
  ANALYSIS_APPROVED: { label: 'Analysis approved', tone: 'success' },
  PLANNING: { label: 'Planning', tone: 'progress' },
  ARCHITECTURE_READY: { label: 'Architecture ready', tone: 'progress' },
  ARCHITECTURE_APPROVED: { label: 'Architecture approved', tone: 'success' },
  PLAN_READY: { label: 'Plan ready', tone: 'progress' },
  PLAN_APPROVED: { label: 'Plan approved', tone: 'success' },
  DEVELOPMENT_APPROVED: { label: 'Development approved', tone: 'success' },
